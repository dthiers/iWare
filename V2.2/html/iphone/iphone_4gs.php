<!DOCTYPE html>
  ...
  <body onload="swap_content()">
  	...
  	<div id="header_left">
  		...
  		<div id="header_right">
  			<img src="images/iphone_front/logos/4gs_logo.png" id="img_logo" alt="4Gs logo">
	...
	<div class="contentwrapper">
		...
		<div id="breadCrumbs">
			<a href="../home/home.php">home</a><a href="iphone.php"> // iPhone</a><a href="iphone_4gs.php"> // iPhone 4GS</a><span id="last_breadcrumb"></span>
		...
		<div class="content">
			<div id="left">
				...
				<?php include('include_info/iphone_info_4s.php'); ?>
			</div>  <!-- End of div left -->
			<div id="right">
				<img id="ip_image" src="images/iphone_front/front/4gs_small.png" alt="4gs front"/>
