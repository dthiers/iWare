<!DOCTYPE html>
 ...
 <body onload="swap_content()">
  	<div class="header">
  		...
  		<div id="header_right">
  			<img src="images/iphone_front/logos/5g_logo.png" id="img_logo" alt="5G logo">
	...
	<div class="contentwrapper">
		...
		<div id="breadCrumbs">
			<a href="../home/home.php">home</a><a href="iphone.php"> // iPhone</a><a href="iphone_5g.php"> // iPhone 5G</a><span id="last_breadcrumb"></span>
		...
		<div class="content">
			<div id="left">
				...
				<?php include('include_info/iphone_info_5g.php'); ?>
			</div>  <!-- End of div left -->
			<div id="right">
				<img id="ip_image" src="images/iphone_front/front/5g_small.png" alt="5C Front"/>
