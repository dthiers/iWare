<!DOCTYPE html>
  ...
  <body onload="swap_content()">
  	<div class="header">
  		...
  		<div id="header_right">
  			<img src="images/iphone_front/logos/3g_logo.png" id="img_logo" alt="3G logo">
	...
	<div class="contentwrapper">
		...
		<div id="breadCrumbs">
			<a href="../home/home.php">home</a><a href="iphone.php"> // iPhone</a><a href="iphone_3g.php"> // iPhone 3G</a><span id="last_breadcrumb"></span>
		</div> <!-- end of div breadCrumbs -->
			
		<div class="content">
			<div id="left">
				<div id="includeContent">
				</div> <!-- End of includeConent -->
				<?php include('include_info/iphone_info_3g.php'); ?>
			</div>  <!-- End of div left -->
			<div id="right">
				<img id="ip_image" src="images/iphone_front/front/3g_small.png" alt="3g front"/>
