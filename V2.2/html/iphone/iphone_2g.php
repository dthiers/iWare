<!DOCTYPE html>
  ...
  <body onload="swap_content()">
  	<div class="header">
  		...
  		<div id="header_right">
  			<img src="images/iphone_front/logos/2g_logo.png" id="img_logo" alt="2G logo">
	...
	<div class="contentwrapper">
		...
		<div id="breadCrumbs">
			<a href="../home/home.php">home</a><a href="iphone.php"> // iPhone</a><a href="iphone_2g.php"> // iPhone 2G</a><span id="last_breadcrumb"></span>
		...
		<div class="content">
			...
			<div id="left">
				<div id="includeContent">
					...
					<?php include('include_info/iphone_info_2g.php'); ?>
					
			</div>  <!-- End of div left -->
			<div id="right">
				<img id="ip_image" src="images/iphone_front/front/2g_small.png" alt="2G front"/>
