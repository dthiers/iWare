<!DOCTYPE html>
  ...
  <body onload="swap_content()">
  	<div class="header">
  		...
  		<div id="header_right">
  			<img src="images/iphone_front/logos/5gc_logo.png" id="img_logo" alt="5GC logo">
	...
	<div class="contentwrapper">
		...
		<div id="breadCrumbs">
			<a href="../home/home.php">home</a><a href="iphone.php"> // iPhone</a><a href="iphone_5gc.php"> // iPhone 5GC</a><span id="last_breadcrumb"></span>
		...
		<div class="content">
			...
			<div id="left">
				...
				<?php include('include_info/iphone_info_5gc.php'); ?>
			</div>  <!-- End of div left -->
			<div id="right">
				<img id="ip_image" src="images/iphone_front/front/5gc_small.png" alt="5gc front"/>
